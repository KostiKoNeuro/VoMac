...
const en = {
  ...
  "about.desc": "System-wide voice dictation with an overlay-driven transcription flow.",
  ...
  "about.blurb": "Dicta is a clean, minimal dictation overlay. Press the global hotkey anywhere, speak, and insert text directly into any application.",
  ...
  "general.autostart.label": "Open at login",
  "general.autostart.desc": "Automatically launch Dicta when your session starts.",
  "general.autostart.aria": "Enable launch at login",
  ...
  "recording.desc": "Input behavior and MVP recording controls.",
  ...
  "recording.hotkey.inputHint.mac": "Examples: ⌘⇧Space, ⌥Space",
  ...
  "recording.microphone.desc": "Which audio input to capture speech from. \"System default\" follows the device selected in your system settings.",
  ...
  "insertion.copiedFallback": "Auto-insert failed. Text was copied to the clipboard — paste it manually.",
  ...
  "permissions.accessibility.desc": "Dicta needs Accessibility permission to insert dictated text and rewrite results into other apps. Grant it in System Settings → Privacy & Security → Accessibility.",
  "permissions.accessibility.action": "Open Settings",
  "permissions.accessibility.dismiss": "Later",
  ...
  "rewriter.presets.promptEditor.hint.mac": "⌘Enter to save · Esc to cancel",
...
const ru: TranslationDictionary = {
  "vo.title": "Dicta",
  "vo.subtitle": "Голосовая диктовка",
  ...
  "about.title": "О Dicta",
  "about.desc": "Глобальная голосовая диктовка с удобным оверлеем.",
  "about.version": "Версия 0.1.0-beta",
  "about.badge": "Бета-версия",
  "about.dev.label": "Разработчик",
  "about.dev.name": "Ботанутый Костя",
  "about.telegram": "Telegram",
  "about.blurb": "Dicta — это чистый, минималистичный оверлей диктовки. Нажмите глобальный хоткей в любом месте, скажите текст, и он будет вставлен прямо в активное приложение.",
  ...
  "general.autostart.label": "Запускать при входе в систему",
  "general.autostart.desc": "Автоматически запускать Dicta при входе в систему.",
  "general.autostart.aria": "Включить запуск при входе в систему",
  ...
  "general.liveInsert.desc": "Со стриминговым провайдером (Deepgram) распознанный текст печатается прямо в поле ввода во время речи — как во встроенной диктовке системы. Буфер обмена не затрагивается.",
  "general.liveInsert.aria": "Включить живую печать",
  "transcription.error.serverError": "Ошибка сервера",

  "recording.title": "Запись",
  "recording.desc": "Поведение ввода и базовые настройки записи.",
  ...
  "recording.hotkey.inputHint.mac": "Примеры: ⌘⇧Space, ⌥Space",
  ...
  "recording.microphone.desc": "С какого аудиовхода записывать речь. «Системный по умолчанию» следует за устройством, выбранным в системе.",
  ...
  "insertion.copiedFallback": "Автовставка не удалась. Текст скопирован в буфер обмена — вставьте его вручную.",
  ...
  "permissions.accessibility.title": "Требуется доступ к Универсальному доступу",
  "permissions.accessibility.desc": "Dicta нужен доступ к Универсальному доступу, чтобы вставлять продиктованный текст и результаты рерайта в другие приложения. Выдайте разрешение: Системные настройки → Конфиденциальность и безопасность → Универсальный доступ.",
  "permissions.accessibility.action": "Открыть настройки",
  "permissions.accessibility.dismiss": "Позже",
  ...
  "rewriter.presets.promptEditor.hint.mac": "⌘Enter чтобы сохранить · Esc чтобы отменить",
